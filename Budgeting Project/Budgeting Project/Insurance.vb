Public Class frmInsurance
    ...
    Private Sub TblInsuranceBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs) Handles TblInsuranceBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.TblInsuranceBindingSource.EndEdit()
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        ...
        If dlgButton = Windows.Forms.DialogResult.Yes Then
            ...
            row =
                BudgetDataSet.tblInsurance.FindBy_Transaction__(intTransaction)
            row.Delete()
            Try
